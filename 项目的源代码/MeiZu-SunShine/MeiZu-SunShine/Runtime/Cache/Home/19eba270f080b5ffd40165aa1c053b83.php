...
<html>
	<head>
		...
		<link href="/xiangmu/xiangmu/MeiZu-SunShine/Public/Home/css/register.css" type="text/css"  rel="Stylesheet"/>
		<script src="/xiangmu/xiangmu/MeiZu-SunShine/Public/Home/js/jquery-1.11.3.min.js"></script>
		<script src="/xiangmu/xiangmu/MeiZu-SunShine/Public/js/ajax3.0-min.js"></script>
	</head>
	<body>
		<!--头部开始-->
		<div class="top">
