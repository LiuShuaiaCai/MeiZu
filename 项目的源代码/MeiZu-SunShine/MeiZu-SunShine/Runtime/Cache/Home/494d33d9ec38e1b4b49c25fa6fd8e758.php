<?php if (!defined('THINK_PATH')) exit();?>		<!-- 引入头部 -->
	...
	<!--购物车top-->
	<div class="store_top">
		<img src="/xiangmu/MeiZu-SunShine/Public/Home/images/liu.gif" alt="">
	</div>
	...
	<div class="store_center1">
		<table class="table">
			...
			<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class='shangpin'>
						...
						<td>
							<div class="goods">
								<div class="pic"><img src="/xiangmu/MeiZu-SunShine/Public/<?php echo ($vo['pic']); ?>" alt=""></div>
								<div class="texts">
		...
		<div height='140px' id='empty'>
			<div>
				<img src="/xiangmu/MeiZu-SunShine/Public/Home/images/002.gif" alt="">
	...
	<script>var url = '/xiangmu/MeiZu-SunShine/index.php/Home'</script>
	...
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/bootstrap.min.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/jQuery.md5.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/header.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/index.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/detail.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/shop.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/shop2.js'></script>
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/shop3.js'></script>
	
	
	
	<script src='/xiangmu/MeiZu-SunShine/Public/Home/js/footer.js'></script>
</body>
</html>