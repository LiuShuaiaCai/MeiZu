<?php if (!defined('THINK_PATH')) exit();?>		<!-- 引入头部 -->
	...
	<!--购物车top-->
	<div class="store_top">
		<img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/Home/images/liu2.gif" alt="">
	</div>
	...
	<div class="store_center1">
		...
		<table class="table">
			<?php if(is_array($data)): foreach($data as $key=>$vo2): ?><tr class='shangpin jg' data=<?php echo ($vo2['id']); ?>>
					<td>
						<div class="goods">
							<div class="pic"><img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo ($vo2['pic']); ?>" alt=""></div>
							<div class="texts">
		...
		<table class="table" id='buy2' data=<?php echo ($buy['id']); ?>>
			<tr class='shangpin'>
					<td>
						<div class="goods">
							<div class="pic"><img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo ($buy['pic']); ?>" alt=""></div>
							<div class="texts">
