...
<!-- /.navbar-static-side -->
    ...
    <a href="<?php echo U('Order/order');?>">返回上一层</a>
    <div class="panel-body">
    <?php if(is_array($check)): foreach($check as $key=>$vo): ?><div class="watch">
        <div class='look_user'>
            <span class="userName">用户名：<?php echo ($vo['userName']); ?></span>
            <span class="userPhone">电话：<?php echo ($vo['phone']); ?></span>
        </div>
        <div class='look_goods'>
            <div>
                <img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo ($vo['pic']); ?>" alt=""><br>
                <div class="good">
                    <span class="gname">商品：<?php echo ($vo['gname']); ?></span><br>
                    <span class="gstyle">样式：<?php echo ($vo['desc']); ?> <?php echo ($vo['desc']); ?> <?php echo ($vo[net]); ?> <?php echo ($vo['color']); ?> <?php echo ($vo['mem']); ?> X <?php echo ($vo['snum']); ?></span><br>
                    <span class="gstyle">价格：<?php echo ($vo['price']); ?></span><br>
                    <span class="gstyle">订单号：<?php echo ($vo['number']); ?></span><br>
                    <span class="gstyle">订单时间：<?php echo (date('Y-m-d h:i:s',$vo['orderTime'])); ?></span>
                </div>
            </div>
        </div>
        <div class='look_name'>
            <span class='look_person'>收货人：<?php echo ($vo['person']); ?></span>
            <span class="look_aphone">联系方式：<?php echo ($vo['aphone']); ?></span>
        </div>
        <div class='look_adress'>
        收货地址：<?php echo ($vo['province']); ?> <?php echo ($vo['city']); ?> <?php echo ($vo['county']); ?> <?php echo ($vo['town']); ?> <?php echo ($vo['more']); ?>
        </div>
