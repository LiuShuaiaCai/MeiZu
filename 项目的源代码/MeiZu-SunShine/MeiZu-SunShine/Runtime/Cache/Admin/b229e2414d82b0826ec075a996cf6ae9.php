...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">修改商品详情</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <form  action="<?php echo U('Images/imagesupdateG');?>"  method="post" role="form" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                        <div class="form-group">
                            <label>分类ID:<?php echo ($data['id']); ?></label>
                            
                        </div>
                        <!-- <div class="form-group">
                            <label>商品名称:</label>
                            <input type="text" name="gname" value="<?php echo ($data['gname']); ?>" class="form-control">
                        </div> -->
