...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">热门问题</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('Question/update');?>" enctype="multipart/form-data" >
