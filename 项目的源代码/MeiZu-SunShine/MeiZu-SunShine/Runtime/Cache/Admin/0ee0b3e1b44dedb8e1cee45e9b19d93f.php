...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">公告列表 <br> <a href="<?php echo U('Notice/add');?>" style="font-size:20px">添加公告</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
    <div class="table-responsive">
        ...
        <form action="" method="get">
            管理员：<input type="text" name="content" value="<?php echo I('get.content');?>">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$value): ?><tr class="success">
                    ...
                    <td><?php echo (date("Y-m-d H:i:s",$value['ntime'])); ?></td>
                    <td>
                        <a href="<?php echo U('Notice/edit',array('id'=>$value['id']));?>">修改</a>
                        <span>|</span>
                        <a href="<?php echo U('Notice/del',array('id'=>$value['id']));?>">删除</a>
                        <span>|</span>
                    <a href="<?php echo U('Notice/enable');?>?id=<?php echo ($value['id']); ?>&status=<?php echo ($value['status']); ?>
