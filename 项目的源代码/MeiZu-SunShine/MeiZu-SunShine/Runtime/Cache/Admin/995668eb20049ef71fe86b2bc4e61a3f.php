                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                                ...
                                                <td><?php echo (date('Y-m-d',$vo['ztime'])); ?></td>
                                                <!-- <td><?php echo ($vo['zip']); ?></td> -->
                                                <td>
                                                    <a href="<?php echo U('User/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                                    <span>|</span>
                                                    <span class='notice'></span>
                                                    <a href="<?php echo U('User/delete');?>?id=<?php echo ($vo['id']); ?>" class="del_user">删除</a>
                                                    <span>|</span>
                                                    <a href="<?php echo U('User/enable');?>?id=<?php echo ($vo['id']); ?>&status=<?php echo ($vo['status']); ?>"><?php echo ($vo['status']==1?'禁用':'开启'); ?></a>
                                                </td>
