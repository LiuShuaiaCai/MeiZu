...
<!-- /.navbar-static-side -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <form  action="<?php echo U('Goods/updateG');?>"  method="post" role="form" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">    
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="hot" id="hot">  
                                <option value="1" <?php echo ($data['hot']==1 ? 'selected' : ''); ?>>热卖商品</option>
