...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">添加用户信息</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('User/insert');?>" id='formsub'>
    <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户名：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for main-for-1">
        <input type="text" name="userName" value="<?php echo ($data['userName']); ?>" class="text-word1" require id='input1'><span id='span'></span>
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for main-for-2">
        <input id='input2' type="text" name="phone" value="<?php echo ($data['phone']); ?>" class="text-word1" ><span id='span2'></span>
        </td>
        </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for main-for-2">
        <input id='input3' type="text" name="password" value="" class="text-word1"><span id='span3'></span>
        </td>
        </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input id='submit' name="" type="submit" value="提交" class="text-but">
