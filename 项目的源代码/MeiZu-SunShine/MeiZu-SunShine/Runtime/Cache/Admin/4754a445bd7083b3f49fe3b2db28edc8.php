...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：链接管理&nbsp;&nbsp;>&nbsp;&nbsp;修改链接</td>
  </tr>
  
  <tr>
    <td align="left" valign="top">
    <form action="<?php echo U('Link/update');?>" method="post">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="linkname" value="<?php echo ($data['linkname']); ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">链接地址：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="link" value="<?php echo ($data['link']); ?>" class="text-word">
        </td>
        </tr>
