...
<!-- /.navbar-static-side -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <form  action="<?php echo U('Details/update');?>"  method="post" role="form" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">    
                        
                        
                        <div class="form-group">
                            <label>网络类型</label>
                            <input type="text" name="style" value="<?php echo ($data['style']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>颜色</label>
                            <input type="text" name="color" value="<?php echo ($data['color']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>内存</label>
                            <input type="text" name="memory" value="<?php echo ($data['memory']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>电池</label>
                            <input type="text" name="battery" value="<?php echo ($data['battery']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>尺寸</label>
                            <input type="text" name="size" value="<?php echo ($data['size']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>分辨率</label>
                            <input type="text" name="resolution" value="<?php echo ($data['resolution']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>重量</label>
