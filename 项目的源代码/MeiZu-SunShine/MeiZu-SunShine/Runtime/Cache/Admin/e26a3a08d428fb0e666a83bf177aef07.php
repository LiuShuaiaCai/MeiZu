            ...
            <div class="dataTable_wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <thead>
                            <tr role="row">
                                <th aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending" style="width: 50px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting_asc">
                                    ID
                                </th>
                                <!--<th aria-label="Browser: activate to sort column ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">
                                    分类ID
                                </th>-->
                                ...
                                <th aria-label="CSS grade: activate to sort column ascending" style="width: 150px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">
                                    操作
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr role="row" class="gradeA odd">
                                ...
                                <td><img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo empty($vo['pic1']) ? 'default.jpg' : $vo['pic1'];?>" width="30" alt=""></td>
                                <td><img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo empty($vo['pic2']) ? 'default.jpg' : $vo['pic2'];?>" width="30" alt=""></td>
                                <td><img src="/xiangmu/xiangmu/MeiZu-SunShine/Public/<?php echo empty($vo['pic3']) ? 'default.jpg' : $vo['pic3'];?>" width="30" alt=""></td>
                               
                                <td><a href="<?php echo U('Images/editG',array('id'=>$vo['id']));?>">修改</a>
                                &nbsp;&nbsp;&nbsp;<a href="<?php echo U('Drop/enable');?>?id=<?php echo ($vo['id']); ?>&dels=<?php echo ($vo['dels']); ?>
                    "><?php echo ($vo['dels']==1?'加入回收站':'恢复'); ?></a>
                    &nbsp;&nbsp;&nbsp;
