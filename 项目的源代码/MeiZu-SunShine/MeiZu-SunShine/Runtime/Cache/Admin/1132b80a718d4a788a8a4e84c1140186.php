  ...
  <div class="panel-body">
       <div class="table-responsive">
            ...
            <thead>
                ...
                <th width="30">编号</th>
                <th width="50">网站标题</th>
                <th width="60">网站关键字</th>
                <th width="50">网站描述</th>
                <th width="50">网站logo</th>
                <th width="50">网站版权</th>
                <th width="50">网站开关</th>
                <th width="80">操作</th>
                </tr>
                ...
                <td width="50"><?php echo ($vo['title']); ?></td>
                <td width="60"><?php echo ($vo['keywords']); ?></td>
                <td width="50"><?php echo ($vo['description']); ?></td>
                <td width="50"><?php echo ($vo['logo']); ?></td>
                <td width="50"><?php echo ($vo['copys']); ?></td>
                <td width="50"><?php echo ($vo['status']==1? '开启':'关闭'); ?></td>
                                           
                <td  width="80">
                <a href="<?php echo U('Config/edit',array('id'=>$vo['id']));?>">修改</a>
                <span>|</span>
                <a href="<?php echo U('Config/del',array('id'=>$vo['id']));?>">删除</a>
                <span>|</span>
                <a href="<?php echo U('Config/enable',array('id'=>$vo['id'],'status'=>$vo['status']));?>"><?php echo ($vo['status']==1?'关闭':'开启'); ?></a>
                </td>
