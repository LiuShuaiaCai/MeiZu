...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">积分兑换列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       							...
       							<form>
       							商品：<input type="text" name="name" value="" placeholder="请输出商品名称">
                      ...
                      <table class="table">
                          <thead>
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                            ...
                                            <td>
                                            	<a href="<?php echo U('Dgoods/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                                <span>|</span>
                                            	<a href="<?php echo U('Dgoods/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                            	<span>|</span>
                                            	<!-- <a href="">查看订单</a> -->
                                            </td>
