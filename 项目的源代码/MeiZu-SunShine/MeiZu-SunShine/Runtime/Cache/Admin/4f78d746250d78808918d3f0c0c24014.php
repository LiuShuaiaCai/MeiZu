...
<!-- /.navbar-static-side -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <form  action="<?php echo U('Goods/update');?>"  method="post" role="form" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo ($data['id']); ?>">    
                        <div class="form-group">
                            <label>商品id<?php echo ($data['tid']); ?></label>
                        </div>
                        <div class="form-group">
                            <label>商品名称</label>
                            
                            <input type="text" name="gname" value="<?php echo I('get.name');?>" class="form-control">
                           <!-- <input type="text" name="tname" value="<?php echo ($data['gname']); ?>" class="form-control">-->
                        </div>
                        <div class="form-group">
                            <label>商品状态</label>
                            <select class="form-control" name="status" id="status">  
                                <option value="1" <?php echo ($data['status']==1 ? 'selected' : ''); ?>>上架</option>
                                <option value="2" <?php echo ($data['status']==2 ? 'selected' : ''); ?>>下架</option>
                            </select>
                        </div> 
                        <div class="form-group">
                            <label>热卖商品</label>
                            <select class="form-control" name="hot" id="hot">  
                                <option value="1" <?php echo ($data['hot']==1 ? 'selected' : ''); ?>>强力推荐</option>
                                <option value="2" <?php echo ($data['hot']==2 ? 'selected' : ''); ?>>新品</option>
                            </select>
                        </div> 
                        <div class="form-group">
                            <label>商品价格</label>
                        ...
                        <div class="form-group">
                            <label>商品数量</label>
                            <input type="text" name="num" value="<?php echo ($data['num']); ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>商品描述</label>
                            <textarea class="form-control" rows="3" name="desc" ><?php echo ($data['desc']); ?></textarea>
                        </div> 
                        <div class="form-group">
                            <label>商品图像</label>
                            <input type="file" name="pic" value="<?php echo ($data['pic']); ?>" class="form-control">
                        </div>
