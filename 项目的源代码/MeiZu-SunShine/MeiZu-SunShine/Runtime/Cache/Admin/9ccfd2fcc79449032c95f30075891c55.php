...
<!-- /.navbar-static-side -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       							...
       							<form>
       							问题名称：<input type="text" name="title" value="" placeholder="请输出问题名称">
                                ...
                                <table class="table">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                            ...
                                            <td>
                                            	<a href="<?php echo U('Qpost/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                                <span>|</span>
                                            	<a href="<?php echo U('Qpost/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                            </td>
