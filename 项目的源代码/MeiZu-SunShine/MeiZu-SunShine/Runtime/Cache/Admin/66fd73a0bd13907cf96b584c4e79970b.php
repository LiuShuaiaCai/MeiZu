...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">评价回复列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                		<?php if(is_array($dataf)): foreach($dataf as $key=>$vo1): ?><div class="form-group">
                            <label>商品名称：<span style="color:red;font-size:20px"><?php echo ($vo1['gname']); ?></span></label>
                        </div>
                        <div class="form-group">
                            <label>评价人：<span style="color:red;font-size:20px"><?php echo ($vo1['username']); ?></span></label>
                            
                        </div> 
                        <div class="form-group">
                            <label>评价内容：<span style="color:red;font-size:20px"><?php echo htmlspecialchars_decode($vo1['content']);?></span></label>
                            
                        </div> 
                        <div class="form-group">
                            <label>评价时间：<span style="color:red;font-size:20px"><?php echo (date("Y-m-d H:i:s",$vo1['ptime'])); ?></span></label>
                            
                        </div><?php endforeach; endif; ?>
                        <hr>
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="form-group">
                            <label>回复人：<?php echo ($vo['adminname']); ?></label>
                            
                        </div>
                        <div class="form-group">
                            <label>回复内容：<?php echo htmlspecialchars_decode($vo['recontent']);?></label>
                            
                        </div>
                        <div class="form-group">
                            <label>回复时间：<?php echo (date("Y-m-d H:i:s",$vo['retime'])); ?></label>
