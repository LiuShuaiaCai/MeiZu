...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：分类管理&nbsp;&nbsp;>&nbsp;&nbsp;添加商品</td>
  </tr>
 
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('Goods/insert');?>">
    <input type="hidden" name="pid" value="<?php echo I('get.id');?>">
    <div class="form-group">
      <label>父类名称:<?php echo I('get.name');?></label>
      
      <!--<label>所属商品</label>
        <select class="form-control" name="tid">
	        <option value="0">--请选择--</option>-->
	        <!-- 当子级分类的pid和遍历过程中的id相等的时候，这个值就是子级的父类，默认添加 selected-->
	        <!--<?php if(is_array($data)): foreach($data as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['tname']); ?></option><?php endforeach; endif; ?>
      	</select>-->
    </div>
