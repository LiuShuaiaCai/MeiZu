...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">网站配置</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('Config/update');?>" enctype="multipart/form-data" >
    ...
    <input type="hidden" name='id' value="<?php echo ($data['id']); ?>">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="title" value="<?php echo ($data['title']); ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">网站关键字：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="keywords" value="<?php echo ($data['keywords']); ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">网站描述：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="description" value="<?php echo ($data['description']); ?>" class="text-word">
        </td>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="copys" value="<?php echo ($data['copys']); ?>" />
        </td>
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">网站开关：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        开：<input type="radio" name="status" value="1" <?php echo ($data['status']==1?'checked':''); ?>>
        关：<input type="radio" name="status" value="2" <?php echo ($data['status']==2?'checked':''); ?> >
        </td>
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
