...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">修改订单信息</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('Order/update');?>">
    <input type="hidden" name='id' value="<?php echo ($data2['orderid']); ?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">订单号：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="number" value="<?php echo ($data2['number']); ?>" class="text-word" readonly="">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="gname" value="<?php echo ($data2['gname']); ?>" class="text-word" readonly="">
        </td>
        </tr>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="net" id="">
          <option value="<?php echo ($data2['net']); ?>"><?php echo ($data2['net']); ?></option>
          <option value="联通版">联通版</option>
          <option value="移动版">移动版</option>
          <option value="电信版">电信版</option>
        ...
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">商品颜色：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        ...
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">手机内存：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="mem" id="">
          <option value="<?php echo ($data2['mem']); ?>"><?php echo ($data2['mem']); ?></option>
        ...
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">商品数量：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="snum" id="">
          <option value="<?php echo ($data2['snum']); ?>"><?php echo ($data2['snum']); ?></option>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="person" value="<?php echo ($data2['person']); ?>" class="text-word" readonly="">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">收件人电话：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="aphone" value="<?php echo ($data2['aphone']); ?>" class="text-word" readonly="">
        </td>
      </tr>
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <div>
          <?php echo ($data2['province']); echo ($data2['city']); echo ($data2['county']); echo ($data2['town']); echo ($data2['more']); ?>
        </div>
        <span><a href="<?php echo U('Adress/edit');?>?id=<?php echo ($data2['aid']); ?>">修改地址</a></span>
        </td>
      </tr>
