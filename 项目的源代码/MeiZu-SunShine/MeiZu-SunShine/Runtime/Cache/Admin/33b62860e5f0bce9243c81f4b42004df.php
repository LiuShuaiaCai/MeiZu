        ...
        <div class="panel-body">
            <div class="dataTable_wrapper">
                ...
                <div class="row">
                  <div>
                        <form action="">
                            &nbsp;&nbsp;&nbsp;&nbsp;<input placeholder="请输入商品名称" type="text" name="gname" value="<?php echo I('get.gname');?>">
                    ...
                    <table aria-describedby="dataTables-example_info" role="grid" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example">
                        <thead>
                          <tr role="row">
                            ...
                            <th aria-label="Platform(s): activate to sort column ascending" style="width: 120px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">
                              用户名
                            </th>
                        ...
                        <tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr role="row" class="gradeA odd">
                                ...
                                <td><a href="<?php echo U('Goodspl/reply',array('id'=>$vo['id'],'name'=>$vo['tname']));?>">回复</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Goodspl/indexlist',array('id'=>$vo['id'],'name'=>$vo['tname']));?>">回复管理</a></td>
