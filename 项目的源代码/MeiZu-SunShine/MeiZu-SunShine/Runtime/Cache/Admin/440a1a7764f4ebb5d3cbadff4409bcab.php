...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">管理员权限列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       	    <form>
             权限查询：<input type="text" name="title" value="<?php echo I('get.title');?>" placeholder="请输入权限名称">
            ...
            <thead>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                    ...
                    <td>
                    <a href="<?php echo U('Authrule/edit',array('id'=>$vo['id']));?>">修改</a>
                    <span>|</span>
                    <a href="<?php echo U('Authrule/del',array('id'=>$vo['id']));?>">删除</a>
                    <span>|</span>
                    <a href="<?php echo U('Authrule/enable',array('id'=>$vo['id'],'status'=>$vo['status']));?>"><?php echo ($vo['status']==1?'禁用':'开启'); ?></a>                  
                    </td>
