    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo U('User/list');?>">用户列表</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo U('Config/config');?>">配置网站</a>
                    </li>
                </ul>
            </li>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：链接管理&nbsp;&nbsp;>&nbsp;&nbsp;添加链接</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">添加链接信息</a>
    </td>
  </tr>
  <tr>
