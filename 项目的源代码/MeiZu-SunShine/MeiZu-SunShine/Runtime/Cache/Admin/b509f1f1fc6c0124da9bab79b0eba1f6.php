...
<!-- /.navbar-static-side -->
  ...
  <script src="/xiangmu/xiangmu/MeiZu-SunShine/Public/Home/js/jquery-1.11.3.min.js"></script>
       <div class="table-responsive">
								<div>
									<form action="<?php echo U('Video/video');?>" method="get">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
										<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success" >
                                            <td style="line-height:200px"><div><?php echo ($vo["id"]); ?></div></td>
                                            <td>
                                            ...
                                            <td style="line-height:200px;"><div><?php echo ($vo["content"]); ?></div></td>
                                            <td style="line-height:200px;">
												<div>
                                            	<a href="<?php echo U('Video/update');?>?id=<?php echo ($vo["id"]); ?>">更新</a>
                                            	<span>|</span>
                                            	<a href="<?php echo U('Video/delete');?>?id=<?php echo ($vo["id"]); ?>" id="del">删除</a>
                                            	</div>
                                            </td>
