...
<head>
    ...
    <link href="/xiangmu/MeiZu-SunShine/Public/Admin/admin.css" rel="stylesheet">
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：公告管理&nbsp;&nbsp;>&nbsp;&nbsp;修改公告</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">修改公告信息</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('Notice/update');?>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="content" value="<?php echo ($data['content']); ?>" class="text-word">
        </td>
        </tr>
    ...
    <script src="/xiangmu/MeiZu-SunShine/Public/Admin/adress.js"></script>
    <!-- <script src="/xiangmu/MeiZu-SunShine/Public/Admin/jquery-1.11.3.min.js"></script> -->
    ...
    <script>var src='/xiangmu/MeiZu-SunShine/Public';</script>
