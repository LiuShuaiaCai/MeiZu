...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">链接列表 <br> <a href="<?php echo U('Link/add');?>" style="font-size:20px">添加链接</a></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
    <div class="table-responsive">
        <form action="" method="get">
            管理员：<input type="text" name="linkname" value="<?php echo I('get.linkname');?>">
        ...
        <table class="table">
            ...
            <tbody>
            <?php if(is_array($data)): foreach($data as $key=>$value): ?><tr class="success">
                <td><?php echo ($value['id']); ?></td>
                <td><?php echo ($value['linkname']); ?></td>
                <td><?php echo ($value['link']); ?></td>
                <td><?php echo ($value['status']==1?'开启':'禁用'); ?></td>
                <td>
                    <a href="<?php echo U('Link/edit',array('id'=>$value['id']));?>">修改</a>
                    <span>|</span>
                    <a href="<?php echo U('Link/del',array('id'=>$value['id']));?>">删除</a>
                    <span>|</span>
                    <a href="<?php echo U('Link/enable');?>?id=<?php echo ($value['id']); ?>&status=<?php echo ($value['status']); ?>
                    "><?php echo ($value['status']==1?'禁用':'启用'); ?></a>
                </td>
