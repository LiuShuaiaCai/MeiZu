            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>商品名称:</label>&nbsp;<span style="font-weight:bold;font-size:20px;color:red"><?php echo ($data['gname']); ?></span>
                    </div>
                    <div class="form-group">
                        <label>评价内容:</label>&nbsp;<span style="font-weight:bold;font-size:20px;color:red"><?php echo htmlspecialchars_decode($data['content']);?></span>
                        
                    </div> 
                    <form  action="<?php echo U('Goodspl/insert');?>"  method="post" role="form">
                    <input type="hidden" name="adminname" value="<?php echo ($adminname); ?>">
                    <input type="hidden" name="zid" value="<?php echo ($data['id']); ?>">
                    <input type="hidden" name="gid" value="<?php echo ($data['tid']); ?>">
                    <input type="hidden" name="gname" value="<?php echo ($data['gname']); ?>">    
                        <div class="form-group">
                            <label>回复内容</label>
                            <input type="text" name="recontent" value="" class="form-control">
                        </div> 
                        
                        <input type="hidden" name="retime" value="<?php echo time();?>">
