...
<!-- /.navbar-static-side -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       							...
       							<form>
       							回复内容：<input type="text" name="contents" value="" >
                                ...
                                <table class="table">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                            ...
                                            <td><?php echo htmlspecialchars_decode($vo['contents']);?></td>
                                            <td>
                                            	<a href="<?php echo U('Qreply/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                                <span>|</span>
                                            	<a href="<?php echo U('Qreply/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
