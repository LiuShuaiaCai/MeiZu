...
<!-- /.navbar-static-side -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       							...
       							<form>
       							问题名称：<input type="text" name="tname" value="" placeholder="请输出问题名称">
                                ...
                                <table class="table">
                                    ...
                                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                                            ...
                                            <td>
                                            	<a href="<?php echo U('Qtype/edit');?>?id=<?php echo ($vo['id']); ?>">修改</a>
                                                <span>|</span>
                                            	<a href="<?php echo U('Qtype/del');?>?id=<?php echo ($vo['id']); ?>">删除</a>
                                              <!-- <a href="<?php echo U('Qtype/jinyong',array('id'=>$vo['id'],'status'=>$vo['status']));?>"><?php echo ($vo['status']==1?'禁用':'开启'); ?></a> -->
