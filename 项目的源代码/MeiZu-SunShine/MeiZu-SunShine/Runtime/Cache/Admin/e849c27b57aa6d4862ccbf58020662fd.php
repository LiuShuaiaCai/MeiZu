...
<!-- /.navbar-static-side -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <h1 class="page-header">热门问题列表</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="panel-body">
       <div class="table-responsive">
       	    <form>
             问题搜索：<input type="text" name="title" value="">
            ...
            <thead>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="success">
                    ...
                    <td width="425"><?php echo ($vo['title']); ?></td>
                    <td width="425"><?php echo ($vo['content']); ?></td>
                    <td>
                    <a href="<?php echo U('Question/edit',array('id'=>$vo['id']));?>">修改</a>
                    <span>|</span>
                    <a href="<?php echo U('Question/del',array('id'=>$vo['id']));?>">删除</a>
